 ...
 * @author Duy
 */
public class MaGiamGia extends javax.swing.JDialog {

    /**
     * Creates new form MaGiamGia
     */
    public MaGiamGia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MaGiamGia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MaGiamGia dialog = new MaGiamGia(new javax.swing.JFrame(), true);
