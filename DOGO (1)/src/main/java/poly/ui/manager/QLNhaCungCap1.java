...
public class QLNhaCungCap1 extends javax.swing.JDialog {
    
private SupplierDAO supplierDAO = new SupplierDAOImpl();
private List<Supplier> supplierList;
private int currentRow = -1;

 public QLNhaCungCap1(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QLNhaCungCap1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QLNhaCungCap1 dialog = new QLNhaCungCap1(new javax.swing.JFrame(), true);
...
private void setForm(Supplier s) {
    jTextField2.setText(s.getSupplierId());
    jTextField5.setText(s.getSupplierName());
    jTextField4.setText(s.getContactName());
